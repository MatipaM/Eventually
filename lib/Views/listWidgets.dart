...
class _ReviewListTileState extends State<ReviewListTile>{
  ...
  void initState()
  {
    ...
    _review!.contact!.getImageFromStorage().whenComplete(() => setState(() {
        ...
        child: ListTile(
          ...
          leading: GestureDetector(
            ...
            child: CircleAvatar(
             ...
             title: Text("${_conversation!.otherContact!.firstName} ${_conversation!.otherContact!.lastName!}",
             style: const TextStyle(
              fontWeight: FontWeight.bold,
              fontSize: 22.5,
             )),
            subtitle: AutoSizeText(_conversation!.lastMessage!.text!, //not loading
            style: const TextStyle(
             //fontSize: 20
              ),
              minFontSize: 20,
              overflow: TextOverflow.ellipsis,),
              trailing: Text(_conversation!.lastMessage!.getMessageDateTime(), //not loading
              style: const TextStyle(
                fontSize: 15 )),

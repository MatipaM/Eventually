...
@override void initState() {
    ...
    _posting!.getFirstImageFromStorage().whenComplete(() => setState((){
       setState((){});
      }),);
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            ...
            //),
              ...
              Text('R ${_posting!.price} per ticket',
               //Text('R  per night',
              style: const TextStyle(
                fontSize: 12
              ),),
...
class _TripsGridTileState extends State<TripsGridTile>{
  ...
  class JobApplicationGridTile extends StatefulWidget{

  final Posting posting;
  const JobApplicationGridTile({required this.posting, Key? key}): super(key: key);

  @override
  _TripsGridTileState createState() => _TripsGridTileState();
}

class _JobApplicationGridTileState extends State<JobApplicationGridTile>{
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              ...
              //),
                ...
                AutoSizeText(
                '${_posting!.city!} ${_posting!.country!}',
                  style: const TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
                ),),
                Text('R${_posting!.price!}'),
                Text('${_posting!.jobDates!}',
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                )),
            ],

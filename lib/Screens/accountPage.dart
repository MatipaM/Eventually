  ...
  void initState()
  {
    ...
    AppConstants.currentUser!.getImageFromStorage().whenComplete((){
      setState(() {
       ...
       print('account page fetching image: ${AppConstants.currentUser!.displayImage}');
    });
          ...
          Padding(
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  AutoSizeText("${AppConstants.currentUser!.firstName} ${AppConstants.currentUser!.lastName}",

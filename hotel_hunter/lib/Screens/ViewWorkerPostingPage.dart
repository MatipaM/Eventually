...
import 'package:hotel_hunter/Screens/BookWorkersPostingPage.dart';
...
class viewWorkersPostingPage extends StatefulWidget {

  static const String routeName = '/viewWorkersPostingPage';
  final Posting posting;

  const viewWorkersPostingPage({required this.posting, super.key});

  @override
  State<viewWorkersPostingPage> createState() => _viewWorkerPostingPageState();
}

class _viewWorkerPostingPageState extends State<viewWorkersPostingPage> {

 //Posting _posting = widget.posting;
  ...
  void initState(){
   ...
   _posting = widget.posting;
    ...
    setState(() {
        print('the host is ${_posting!.host}');
      });
   });
  ...
  Widget build(BuildContext context) {
    String dropdownValue = _posting.getWorkersList()!.first;
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            '${_posting.host!.firstName!} ${_posting.host!.lastName!} - Organiser', //.getFullName()
              ...
              ListView(
                ...
                children: <Widget>[
                  ...
                  const Padding(
                    ...
                    child: Text("Workers Requried: ", style: TextStyle(
                      fontSize: 25,
                      fontWeight: FontWeight.bold)),
                  ),
                    Padding(
                      ...
                      child: DropdownMenu<String>(
                                    initialSelection: _posting.getWorkersList()!.first,
                      ...
                      dropdownValue = value!;
                                    ...
                                    dropdownMenuEntries: _posting.getWorkersList()!.map<DropdownMenuEntry<String>>((String value) {
                      ...
                      MaterialButton(
                            ...
                            onPressed: (){
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context)=> BookWorkersPostingPage(
                                    posting: _posting,
                                  )
                                  )
                              );
